(function ($) {
  ...
  window.tourmaster_front_confirm_box = function (options) {
    ...
    var confirm_overlay = $(
      '<div class="tourmaster-conform-box-overlay"></div>'
    ).appendTo($("body"));
    var confirm_button = $(
      '<span class="tourmaster-confirm-box-button tourmaster-yes">' +
        settings.yes +
        "</span>"
    );
    var decline_button = $(
      '<span class="tourmaster-confirm-box-button tourmaster-no">' +
        settings.no +
        "</span>"
    );

    var confirm_box = $(
      '<div class="tourmaster-confirm-box-wrapper">\
				<div class="tourmaster-confirm-box-head">' +
        settings.head +
        '</div>\
				<div class="tourmaster-confirm-box-content-wrapper" >\
					<div class="tourmaster-confirm-box-text">' +
        settings.text +
        '</div>\
					<div class="tourmaster-confirm-box-sub">' +
        settings.sub +
        "</div>\
				</div>\
			</div>"
    ).insertAfter(confirm_overlay);

    $('<div class="tourmaster-confirm-box-button-wrapper"></div>')
      .append(decline_button)
  ...
  $.fn.tourmaster_bind_lightbox = function () {
    $(this).on("click", function () {
      var content = $(this).siblings(
        '[data-tmlb-id="' + $(this).attr("data-tmlb") + '"]'
      );
      ...
      if (content.find(".nsl-container-block").length > 0) {
        ...
        lb_content
          ...
          .replaceWith(content.find(".nsl-container-block").clone(true));
  ...
  window.tourmaster_lightbox = function (content) {
    var lightbox_wrap = $(
      '<div class="tourmaster-lightbox-wrapper" ></div>'
    ).hide();
    var lightbox_content_wrap = $(
      '<div class="tourmaster-lightbox-content-cell" ></div>'
    );
    lightbox_wrap.append(lightbox_content_wrap);
    lightbox_content_wrap.wrap(
      $('<div class="tourmaster-lightbox-content-row" ></div>')
    );
  ...
  window.tourmaster_rating = function (container) {
    container
      .find(
        ".tourmaster-review-form-rating, .tourmaster-tour-search-field-rating"
      )
      .each(function () {
        $(this)
          .children(".tourmaster-rating-select")
          .click(function () {
            ...
            if ($(this).is("i")) {
              $(this)
                .removeClass()
                .addClass("tourmaster-rating-select fa fa-star-half-empty");
            }
            $(this)
              .prevAll("i")
              .removeClass()
              .addClass("tourmaster-rating-select fa fa-star");
            $(this)
              .nextAll("i")
              .removeClass()
              .addClass("tourmaster-rating-select fa fa-star-o");
          });
      });
  };
  ...
  $.fn.tourmaster_video_background = function () {
    if (tourmaster_mobile) {
      ...
      if ($(this).attr("data-video-fallback")) {
        $(this).css(
          "background-image",
          "url(" + $(this).attr("data-video-fallback") + ")"
        );
      }
    } else {
            ...
            .each(function () {
              if ($(this).attr("data-player-type") == "vimeo") {
                ...
                if ($("body").children("#tourmaster-youtube-api").length == 0) {
                  $("body").append(
                    '<script type="text/javascript" src="https://www.youtube.com/iframe_api" id="tourmaster-youtube-api" ></script>'
                  );
                }
  ...
  $.fn.tourmaster_set_flexslider = function (filter_elem) {
    ...
    elem.each(function () {
      ...
      if (
        ...
        $(this).attr("data-nav") == "navigation" ||
        $(this).attr("data-nav") == "navigation-outer"
      ) {
        if ($(this).attr("data-nav-parent")) {
          if ($(this).attr("data-nav-type") == "custom") {
            ...
            $(this)
              ...
              .each(function () {
                var flex_nav = $(
                  '<ul class="tourmaster-flex-direction-nav">' +
                ...
                var flex_nav_position = $(this).find(
                  ".tourmaster-flexslider-nav"
                );
                if (flex_nav_position.length) {
                  flex_nav_position.append(flex_nav);
                  flex_attr.customDirectionNav = flex_nav.find(
                    ".tourmaster-flex-prev, .tourmaster-flex-next"
                  );
                }
              });
          }
      ...
      if ($(this).attr("data-vcenter-nav")) {
        flex_attr.start = function (slider) {
          ...
          if (typeof slider.slides != "undefined") {
            ...
            slider.slides
              .filter(".tourmaster-flex-active-slide")
          ...
          if (data.content && ajax_section.attr("data-target")) {
            if (ajax_section.attr("data-target-action") == "append") {
              ...
              if (data.pagination) {
                if (
                  ajax_section.is(
                    ".tourmaster-pagination, .gdlr-core-pagination"
                  )
                ) {
                  ajax_section.slideUp(100, function () {
                    $(this).remove();
                  ...
                  ajax_section
                    .siblings(".tourmaster-pagination, .gdlr-core-pagination")
              ...
              if (data.load_more) {
                ajax_section
                  .siblings(
                    ".tourmaster-load-more-wrap, .gdlr-core-load-more-wrap"
                  )
                  .slideUp(100, function () {
                    $(this).remove();
                  });
  ...
  $.fn.tourmaster_lightgallery = function () {
    ...
    for (var key in lightbox_groups) {
      var group_selector =
        '.tourmaster-lightgallery[data-lightbox-group="' +
        lightbox_groups[key] +
        '"]';
  ...
  $(document).ready(function () {
    ...
    $(".tourmaster-user-top-bar").each(function () {
      ...
      if ($(this).hasClass("tourmaster-user")) {
        var top_bar_nav = $(this)
          .children(".tourmaster-user-top-bar-nav")
          .children(".tourmaster-user-top-bar-nav-inner");
    ...
    $(".tourmaster-currency-switcher").each(function () {
      var currency_inner = $(this).children(
    ...
    $(".tourmaster-user-top-bar.tourmaster-refresh").each(function () {
      ...
      $.ajax({
        ...
        data: {
          action: "refresh_user_top_bar",
          redirect: user_top_bar.attr("data-redirect"),
        },
        dataType: "json",
        success: function (data) {
    ...
    if (body.hasClass("tourmaster-template-register")) {
      ...
      $(".tourmaster-deposit-item-head").on("click", function () {
        ...
        if (item.hasClass("tourmaster-active")) {
          $(this)
            .siblings(".tourmaster-deposit-item-content")
            .css({
              display: "block",
            })
            .slideUp(150);
...
!(function (e) {
  ...
  (e.tourmaster_flexslider = function (a, n) {
    ...
    var r,
      ...
      f = "" !== i.vars.asNavFor,
      h = {};
    e.data(a, "tourmaster_flexslider", i),
      (h = {
        init: function () {
          (i.animating = !1),
            ...
            (!m || (m && i.vars.smoothHeight)) &&
              e(window).bind("resize orientationchange focus", h.resize),
                  ...
                  i.slides.each(function () {
                    ...
                    (t._gesture = new MSGesture()),
                      ...
                      t.addEventListener("MSGestureTap", function (t) {
                        ...
                        var a = e(this),
                          n = a.index();
                        e(i.vars.asNavFor).data("tourmaster_flexslider")
                          .animating ||
                          a.hasClass("active") ||
        ...
        pausePlay: {
          setup: function () {
            ...
            i.controlsContainer
              ...
              h.pausePlay.update(i.vars.slideshow ? s + "pause" : s + "play"),
                        ...
                        ? (!h || Number(new Date()) - l > 500) &&
                          ...
                          !m &&
                            ...
                            (t.vars.animationLoop ||
                              (s =
                                x /
                                ((0 === t.currentSlide && x < 0) ||
                                (t.currentSlide === t.last && x > 0)
                                  ? Math.abs(x) / r + 2
                                  : 1)),
            ...
            : ((c = function (s) {
              ...
              (f = function (o) {
                if (
                  ...
                  i.animatingTo === i.currentSlide && !h && null !== s)
                ) {
                  var c = v ? -s : s,
        ...
        "function" == typeof window.matchMedia
          ? (window.matchMedia("(max-width: 767px)").matches &&
            ...
            window.matchMedia("(max-width: 419px)").matches &&
              ((n = 1), (r = 1)))
          : (e(window).innerWidth() < 767 && ((n = 1), (r = 1)),
            e(window).innerWidth() < 419 && ((n = 1), (r = 1))),
      ...
      if ((void 0 === t && (t = {}), "object" == typeof t))
        return this.each(function () {
          ...
          (1 === i.length && !0 === t.allowOneSlide) || 0 === i.length
            ...
            : void 0 === a.data("tourmaster_flexslider") &&
              new e.tourmaster_flexslider(this, t);
        });
