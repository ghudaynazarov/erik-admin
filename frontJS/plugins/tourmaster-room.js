(function ($) {
  ...
  function tourmaster_get_form_array_data(object, name, value) {
    ...
    if (name_match) {
      ...
      object[name_match[0]] = tourmaster_get_form_array_data(
        object[name_match[0]],
        last_name,
        value
      );
      ...
      if (array_match) {
        ...
        object[array_match[1]] = tourmaster_get_form_array_data(
          object[array_match[1]],
          last_name,
          value
        );
  ...
  $.fn.tourmaster_room_single_review = function () {
    ...
    sort_by.click(function () {
      ...
      $(this)
        .addClass("tourmaster-active")
        .siblings("[data-sort-by]")
        .removeClass("tourmaster-active");
  ...
  function tourmaster_room_get_review_ajax(
    ajax_data,
    content_section,
    scroll_to = null
  ) {
    ...
    $(this).each(function () {
      ...
      function set_amount_selection_label() {
        ...
        items.each(function () {
          ...
          var amount_text = $(this).attr("data-label")
  ...
  $(document).ready(function () {
    ...
    body.on(
      "click",
      ".tourmaster-room-search-tax-wrap .tourmaster-close-filter",
      function () {
        var content_fitler = $(this)
          .parent(".tourmaster-label")
          .siblings(".tourmaster-filter");
    ...
    var cart_button = $("#tourmaster-room-navigation-checkout-button").each(
      function () {
        var cart_wrap = $(this).closest(
        ...
        cart_items.on("click", ".tourmaster-remove", function () {
          ...
          tourmaster_set_cookie(
            "tourmaster-room-cart",
            JSON.stringify(cart_cookie),
            31536000
          );
          ...
          if (cart_cookie.length == 0) {
            ...
            cart_button.html(
              cart_button.attr("data-label") +
                '<span class="tourmaster-count">0</span>'
            );
          }
        });
        ...
        if (login_lb.length) {
          checkout_button.on("click", function () {
            ...
            if (lb_content.find(".nsl-container-block").length > 0) {
              lb_content
                .find(".nsl-container-block")
                .replaceWith(login_lb.find(".nsl-container-block").clone(true));
            }
            ...
            lb_content.find(".tourmaster-continue-button").each(function () {
              $(this).attr(
                "href",
                $(this).attr("href").replace("type=booking", "type=cart")
              );
            });
    ...
    if (body.hasClass("single-room")) {
      body.find(".tourmaster-room-booking-bar-wrap").each(function () {
        ...
        title_wrap.on("click", "[data-room-tab]", function () {
          ...
          var target_tab = content_wrap.find(
            '[data-room-tab="' + tab_id + '"]'
          );
      ...
      body.find("#tourmaster-room-booking-form").each(function () {
        ...
        $(this).on("change", 'input[name="room_amount"]', function () {
          ...
          var guest_selection = $(this)
            .closest(".tourmaster-room-amount-selection")
            .siblings(".tourmaster-room-booking-guest-selection");
        ...
        function bind_booking_bar_summary(
          content_area,
          cart_row,
          form,
          input_data
          ...
          content_area.on("click", ".tourmaster-add-to-cart", function () {
            ...
            if (cart_button.length) {
              var cart_wrap = cart_button.closest(
                ".tourmaster-room-navigation-checkout-wrap"
              );
              var cart_items = cart_button.siblings(
              ...
              cart_button.html(
                cart_button.attr("data-checkout-label") +
                  '<span class="tourmaster-count">' +
                  cart_cookie.length +
                  "</span>"
              );
            }
          ...
          content_area.on("click", ".tourmaster-checkout", function () {
            tourmaster_set_cookie(
              "tourmaster-room-booking-detail",
            ...
            if (login_lb.length) {
              ...
              if (lb_content.find(".nsl-container-block").length > 0) {
                lb_content
                  .find(".nsl-container-block")
                  .replaceWith(
                    login_lb.find(".nsl-container-block").clone(true)
                  );
              }
        ...
        $(this).on("click", 'input[type="submit"]', function () {
          ...
          tourmaster_room_booking_ajax(
            form.attr("data-ajax-url"),
            {
              success: function (data) {
                if (typeof data != "undefined") {
                  if (data.status == "success") {
                    ...
                    var error_message = $(
                      '<div class="tourmaster-room-booking-submit-error" ></div>'
                    );
    ...
    if (body.hasClass("single-room")) {
      ...
      $("#tourmaster-enquiry-form")
        ...
        .click(function () {
          ...
          var message_box = form
            .find(".tourmaster-enquiry-form-message")
            .not(".tourmaster-enquiry-term-message");

          var condition_accepted_input = form.find(
            '[name="tourmaster-require-acceptance"]'
          );
          if (
            condition_accepted_input.length &&
            !condition_accepted_input.is(":checked")
          ) {
            condition_accepted_input
              .siblings(".tourmaster-enquiry-form-message")
              .slideDown(150);
            return false;
          } else {
            condition_accepted_input
          ...
          if (!validate) {
            if (form.attr("data-validate-error")) {
              message_box
                .removeClass("tourmaster-success")
                .addClass("tourmaster-failed");
            ...
            $.ajax({
              ...
              data: {
                action: form.attr("data-action"),
                data: tourmaster_get_form_data(form),
              },
              dataType: "json",
              error: function (jqXHR, textStatus, errorThrown) {
                // print error message for debug purpose
                ...
                if (typeof data.message != "undefined") {
                  if (data.status == "success") {
                    form
                      ...
                      .val("");
                    message_box
                      .removeClass("tourmaster-failed")
                      .addClass("tourmaster-success");
                  } else {
                    message_box
                      .removeClass("tourmaster-success")
                      .addClass("tourmaster-failed");
    ...
    $(".tourmaster-custom-datepicker-wrap").each(function () {
      ...
      var start_date = start_date_input.val()
        ? new Date(start_date_input.val() + "T00:00:00")
        : "";
      var end_date = end_date_input.val()
        ? new Date(end_date_input.val() + "T00:00:00")
        : "";
      if (dp_parent.attr("data-avail-date")) {
        ...
        var max_date = new Date(
          avail_date[avail_date.length - 1] + "T00:00:00"
        );
      } else {
        var avail_date = false;
        if (!start_date) {
          var min_date = new Date(
            dp_parent.attr("data-current-date") + "T00:00:00"
          );
        } else {
      ...
      var number_of_months = dp_parent.hasClass("tourmaster-horizontal")
        ? 2
        : 1;
      var dp = dp_wrap
        .find(".tourmaster-custom-datepicker-calendar")
        .datepicker({
          ...
          onSelect: function (dateText, inst) {
            ...
            if (step == 1) {
              ...
              dp_val.start_date = $.datepicker.formatDate(
                "yy-mm-dd",
                start_date
              );
              dp_val.start_label = $.datepicker.formatDate(
                date_format,
                start_date
              );
      ...
      // click display event
      dp_wrap
        .siblings(".tourmaster-custom-start-date")
        .on("click", function () {
          step = 1;
      ...
      $(document).on("click", function (e) {
        ...
        if (
          !$(e.target).closest(
            ".tourmaster-custom-start-date, .tourmaster-custom-end-date, .tourmaster-custom-datepicker-wrap"
          ).length
        ) {
          close_dp();
        }
    ...
    $("#tourmaster-room-payment-display-page").each(function () {
      ...
      function display_errors(elem, message) {
        var error_html = $(
          '<div class="tourmaster-error-message" ></div>'
        ).html(message);
      ...
      price_sidebar.on("click", ".tourmaster-room-pay-type-item", function () {
        var deposit_amount_wrap = $(this)
          .closest(".tourmaster-room-pay-type")
          .siblings(".tourmaster-deposit-amount");
        $(this)
          .addClass("tourmaster-active")
          .siblings()
          .removeClass("tourmaster-active");
      ...
      price_sidebar.on("click", ".tourmaster-pay-now", function () {
        $(this)
          .siblings(".tourmaster-error-message")
        ...
        var payment_method = $(this)
          .closest(".tourmaster-room-payment-method-wrap")
          .find(".tourmaster-payment-selection")
          .val();
        ...
        tourmaster_room_booking_ajax(
          payment_page.attr("data-ajax-url"),
          {
            success: function (data) {
              if (payment_method == "paypal" && data.payment_content) {
                ...
                var content = $(
                  '<div class="tourmaster-room-payment-lb" ></div>'
                ).html(data.payment_content);
                ...
                content.on("payment_complete", function () {
                  ...
                  $(this)
                    .closest(".tourmaster-lightbox-wrapper")
                    .trigger("lightbox_close");
                });
              }
    ...
    $("#tourmaster-room-payment-page").each(function () {
      ...
      var booking_details = JSON.parse(
        payment_page.attr("data-booking-details")
      );
            ...
            payment_page.attr("data-ajax-url"),
            {
              success: function (data) {
                ...
                if (data.price_sidebar) {
                  ...
                  price_sidebar_content
                    .find(".tourmaster-room-coupon-code")
                    .val(last_coupon_code);
                  price_sidebar
                    .children(".tourmaster-room-price-sidebar")
                    .replaceWith(price_sidebar_content);
                }
                ...
                if (data.service_prices) {
                  var i = 0,
                    j = 0;
                  service_form
                    .find(".tourmaster-room-price-summary-block")
                    .each(function () {
                      $(this)
                        .find(".tourmaster-service-total .tourmaster-tail")
                        .each(function () {
      ...
      price_sidebar.on(
        ...
        tourmaster_debounce(function (e) {
          ...
          if (coupon_code) {
            tourmaster_room_booking_ajax(
              ...
              {
                success: function (data) {
                  var message = $('<div class="tourmaster-message" ></div>')
                    .html(data.message)
                    .css("display", "none");
        ...
        tourmaster_room_booking_ajax(
          payment_page.attr("data-ajax-url"),
          {
            success: function (data) {
              ...
              step3_wrap
                .find(".tourmaster-room-sidebar-summary-wrap")
                .html(data.price_sidebar);
              change_step(3);
            },
          },
          {
      ...
      // step 3
      var contact_form = step3_wrap.find(
        ".tourmaster-room-contact-detail-wrap"
      );
      ...
      function get_booking_data() {
        ...
        var required_billing = contact_form
          .find(".tourmaster-payment-billing-separate")
          .is(":checked");
      ...
      step3_wrap.on(
        "change",
        ".tourmaster-payment-billing-separate",
        function () {
          var billing_wrap = $(this)
            .closest(".tourmaster-payment-billing-separate-wrap")
            .siblings(".tourmaster-room-payment-billing-wrap");
