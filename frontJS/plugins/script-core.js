(function ($) {
  ...
  hotale_sf_menu.prototype = {
    ...
    sf_menu_position: function () {
      ...
      var sub_normal_menu = this.main_menu.find(
        ".sf-menu > li.hotale-normal-menu .sub-menu"
      );
      ...
      sub_normal_menu
        ...
        .removeClass("sub-menu-right sub-menu-left");
      ...
      this.main_menu
        .find(".sf-menu > li.hotale-mega-menu .sf-mega")
        .each(function () {
    ...
    init_slidebar: function () {
            ...
            if (nav_element.length > 0) {
              if (t.slide_bar_width > 0) {
                ...
                if (t.slide_bar.hasClass("hotale-left")) {
                  ...
                  var sbl =
                    nav_element.position().left +
                    (nav_element.outerWidth() - sbw) / 2 -
                    t.slide_bar_offset;
                }
              } else {
      ...
      $(window).on("hotale-navigation-slider-bar-animate", function () {
        t.animate_slidebar_pos();
      });
    }, // init_slidebar
      ...
      if (t.current_menu.length > 0) {
        if (t.slide_bar_width > 0) {
          ...
          if (t.slide_bar.hasClass("hotale-left")) {
            ...
            var sbl =
              t.current_menu.position().left +
              (t.current_menu.outerWidth() - sbw) / 2 -
              t.slide_bar_offset;
          }
        } else {
  ...
  $.fn.hotale_mobile_menu = function (args) {
    ...
    var extensions = {
      offCanvas: {
        pageNodetype: ".hotale-body-outer-wrapper",
      },
    };
    ...
    $(this)
      ...
      .each(function () {
        ...
        $('<span class="hotale-mm-menu-blank" ></span>')
          .html(content)
          .insertBefore($(this));
        $(this).remove();
      });
  ...
  hotale_header_side_nav.prototype = {
    ...
    init_nav_bar_element: function () {
      ...
      var middle_pos = t.side_nav_content
        .children(".hotale-pos-middle")
        .addClass("hotale-active");
      var bottom_pos = t.side_nav_content
        .children(".hotale-pos-bottom")
        .addClass("hotale-active");
      ...
      if ($(window).height() < t.side_nav_content.height()) {
        ...
        t.side_nav
          .removeClass("hotale-allow-slide hotale-fix-top hotale-fix-bottom")
          .css("top", "");
        ...
        if (t.side_nav.hasClass("hotale-style-middle")) {
          middle_pos.each(function () {
            ...
            if (prespace > 0) {
              $('<div class="hotale-pre-spaces" ></div>')
                .css("height", prespace)
                .insertBefore($(this));
            }
          });
  ...
  var hotale_anchor = function () {
    this.anchor_link = $('a[href*="#"]')
      ...
      .filter(function () {
        ...
        if (
          $(this).is(
            ".hotale-mm-menu-button, .mm-next, .mm-prev, .mm-title, .gdlr-core-ilightbox"
          )
        ) {
          return false;
        }
        ...
        if (
          ...
          $(this).not('[class^="hotale"]').closest(".woocommerce").length
        ) {
    ...
    if (this.anchor_link.length || window.location.hash.length) {
      ...
      this.home_anchor = this.menu_anchor.find(
        "ul.sf-menu > li.current-menu-item > a, ul.sf-menu > li.current-menu-ancestor > a, .hotale-bullet-anchor-link.current-menu-item"
      );
    ...
    scroll_to: function (hash, redirect, duration) {
      ...
      if (typeof scroll_position != "undefined") {
        ...
        if (
          ...
          typeof window.hotale_anchor_offset != "undefined" &&
          !isNaN(window.hotale_anchor_offset)
        ) {
          scroll_position =
            scroll_position - parseInt(window.hotale_anchor_offset);
        }
          ...
          t.home_anchor.each(function () {
            if ($(this).hasClass("hotale-bullet-anchor-link")) {
              $(this)
                ...
                .removeClass("current-menu-item");
              $(this)
                .parent(".hotale-bullet-anchor")
                .attr("data-anchor-section", "hotale-home");
            } else if (
  ...
  var hotale_sticky_navigation = function () {
    ...
    // get navigation
    t.sticky_nav = $(
      ".hotale-with-sticky-navigation .hotale-sticky-navigation"
    );
    ...
    if (t.sticky_nav.hasClass("hotale-sticky-navigation-height")) {
      ...
      window.hotale_anchor_offset = parseInt(
  ...
  hotale_sticky_navigation.prototype = {
    ...
    style_fixed: function () {
      var t = this;
      var placeholder = $(
        '<div class="hotale-sticky-menu-placeholder" ></div>'
      );
      ...
      $(window).on("scroll hotale-set-sticky-navigation", function () {
        ...
        if (!t.sticky_nav.hasClass("hotale-fixed-navigation")) {
          if ($(window).scrollTop() + page_offset > t.sticky_nav.offset().top) {
            ...
            setTimeout(function () {
              t.sticky_nav.addClass("hotale-animate-fixed-navigation");
            }, 10);
            setTimeout(function () {
          ...
          if ($(window).scrollTop() + page_offset <= placeholder.offset().top) {
            ...
            setTimeout(function () {
              t.sticky_nav.removeClass("hotale-animate-fixed-navigation");
            }, 10);
            setTimeout(function () {
              t.sticky_nav.css("height", "");
              $(window).trigger("hotale-navigation-slider-bar-animate");
        ...
        if (!t.sticky_nav.hasClass("hotale-fixed-navigation")) {
          if (
            ...
            t.sticky_nav.addClass(
              "hotale-fixed-navigation hotale-animate-fixed-navigation"
            );
    ...
    style_mobile_slide: function () {
      var t = this;
      var placeholder = $(
        '<div class="hotale-sticky-mobile-placeholder" ></div>'
      );
  ...
  function hotale_lightbox(content) {
    var lightbox_wrap = $(
      '<div class="hotale-lightbox-wrapper" ></div>'
    ).hide();
    var lightbox_content_wrap = $(
      '<div class="hotale-lightbox-content-cell" ></div>'
    );
    lightbox_wrap.append(lightbox_content_wrap);
    lightbox_content_wrap.wrap(
      $('<div class="hotale-lightbox-content-row" ></div>')
    );
  ...
  $(document).ready(function () {
    ...
    $(
      "#hotale-main-menu, #hotale-right-menu, #hotale-mobile-menu, #hotale-top-bar-menu"
    ).each(function () {
    ...
    if (typeof wc_add_to_cart_params != "undefined") {
      $("body").on("added_to_cart", function () {
        $.ajax({
          ...
          data: {
            action: "top_bar_woocommerce_cart",
          },
          dataType: "json",
    ...
    // hotale
    $("#hotale-dropdown-hotale-flag").hover(
      function () {
    ...
    $(
      ".hotale-header-boxed-wrap, .hotale-header-background-transparent, .hotale-navigation-bar-wrap.hotale-style-transparent"
    ).each(function () {
    ...
    $("body.error404, body.search-no-results").each(function () {
      ...
      var body_wrap_offset = parseInt(
        $(this)
          .children(".hotale-body-outer-wrapper")
          .children(".hotale-body-wrapper")
          .css("margin-bottom")
      );
    ...
    $("body")
      ...
      .each(function () {
        ...
        $("a[href]")
          .not(
            '[href^="#"], [href^="mailto:"], [target="_blank"], .gdlr-core-js, .strip, .sf-with-ul, .remove, .ajax_add_to_cart, .comment-reply-link'
          )
          .on("click", function (e) {
            if (
              e.which != 1 ||
              $(this).hasClass("hotale-no-preload") ||
              e.ctrlKey
            )
              return;
    ...
    $("[data-hotale-lb]").click(function () {
      var lb_content = $(this).siblings(
        '[data-hotale-lb-id="' + $(this).attr("data-hotale-lb") + '"]'
      );
    ...
    $("#hotale-float-social").each(function () {
      ...
      $(window).on("scroll float-social", function () {
        ...
        if (float_social_item.hasClass("hotale-display-after-title")) {
          var blog_offset = 0;
          content_area.children(".hotale-blog-title-wrap").each(function () {
            blog_offset = $(this).outerHeight();
          });

          if (
            float_social_item.offset().top >=
            content_area.offset().top + blog_offset - content_offset
          ) {
            float_social_item.animate(
              {
                opacity: 1,
              },
              {
        ...
        if (fs_pos > footer.offset().top) {
          ...
          pb_body.children().each(function () {
            ...
            if (
              fs_pos > $(this).offset().top &&
              fs_pos < $(this).offset().top + $(this).outerHeight()
            ) {
    ...
    $("#hotale-side-content-menu").each(function () {
      ...
      side_content_menu.on(
        "click",
        ".hotale-side-content-menu-close",
        function () {
  ...
  $(window).on("load", function () {
    ...
    $("#hotale-fixed-footer").each(function () {
      ...
      var placeholder = $(
        '<div class="hotale-fixed-footer-placeholder" ></div>'
      );
    ...
    $("body")
      .not(".woocommerce-cart, .woocommerce-checkout")
