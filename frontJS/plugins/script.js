...
!(function (T) {
  ...
  (T.goodlayers_flexslider = function (p, e) {
    ...
    var t,
      ...
      w = "" !== m.vars.asNavFor,
      b = {};
    T.data(p, "goodlayers_flexslider", m),
      (b = {
        init: function () {
          (m.animating = !1),
            ...
            (m.slides = T(m.vars.selector, m)),
            (m.container = T(m.containerSelector, m)),
            (m.count = m.slides.length),
            (m.syncExists = 0 < T(m.vars.sync).length),
            "slide" === m.vars.animation && (m.vars.animation = "swing"),
            (m.prop = h ? "top" : "marginLeft"),
            (m.args = {}),
            (m.manualPause = !1),
            (m.stopped = !1),
            (m.started = !1),
            ...
            (m.ensureAnimationEnd = "") !== m.vars.controlsContainer &&
              (m.controlsContainer =
                0 < T(m.vars.controlsContainer).length &&
                T(m.vars.controlsContainer)),
            "" !== m.vars.manualControls &&
              (m.manualControls =
                0 < T(m.vars.manualControls).length &&
                T(m.vars.manualControls)),
            "" !== m.vars.customDirectionNav &&
              (m.customDirectionNav =
                2 === T(m.vars.customDirectionNav).length &&
                T(m.vars.customDirectionNav)),
            m.vars.randomize &&
            ...
            m.doMath(),
            m.setup("init"),
            m.vars.controlNav && b.controlNav.setup(),
            m.vars.directionNav && b.directionNav.setup(),
            m.vars.keyboard &&
              (1 === T(m.containerSelector).length ||
            ...
            m.vars.pausePlay && b.pausePlay.setup(),
            m.vars.slideshow &&
              m.vars.pauseInvisible &&
              b.pauseInvisible.init(),
            m.vars.slideshow &&
              (m.vars.pauseOnHover &&
                m.hover(
                  function () {
              ...
              (m.vars.pauseInvisible && b.pauseInvisible.isHidden()) ||
                (0 < m.vars.initDelay
                  ? (m.startTimeout = setTimeout(m.play, m.vars.initDelay))
                  : m.play())),
            w && b.asNav.setup(),
            g && m.vars.touch && b.touch(),
        ...
        asNav: {
          setup: function () {
            (m.asNav = !0),
              ...
              m.slides
                .removeClass(v + "active-slide")
                .eq(m.currentItem)
                .addClass(v + "active-slide"),
              f
                ? (p._slider = m).slides.each(function () {
                    ...
                    (e._gesture = new MSGesture()),
                      ...
                      e.addEventListener("MSGestureTap", function (e) {
                        ...
                        var t = T(this),
                          a = t.index();
                        T(m.vars.asNavFor).data("goodlayers_flexslider")
                          .animating ||
                          t.hasClass("active") ||
                ...
                : m.slides.on(r, function (e) {
                    ...
                    var t = T(this),
                      a = t.index();
                    t.offset().left - T(m).scrollLeft() <= 0 &&
                    t.hasClass(v + "active-slide")
        ...
        controlNav: {
          setup: function () {
            m.manualControls
              ? b.controlNav.setupManual()
              : b.controlNav.setupPaging();
          },
          setupPaging: function () {
            var e,
              ...
              n = 1;
            if (
              ((m.controlNavScaffold = T(
                '<ol class="' + v + "control-nav " + v + a + '"></ol>'
              )),
              1 < m.pagingCount)
            )
              for (var i = 0; i < m.pagingCount; i++) {
                if (
                  ...
                  (altText =
                    "" !== t.attr("data-thumb-alt")
                      ? (altText = ' alt="' + t.attr("data-thumb-alt") + '"')
                      : ""),
                  (e =
                    "thumbnails" === m.vars.controlNav
                      ? '<img src="' +
                  ...
                  "" !== s &&
                    void 0 !== s &&
                    (e += '<span class="' + v + 'caption">' + s + "</span>");
                }
                m.controlNavScaffold.append("<li>" + e + "</li>"), n++;
              }
            m.controlsContainer
              ? T(m.controlsContainer).append(m.controlNavScaffold)
        ...
        directionNav: {
          setup: function () {
            ...
            m.customDirectionNav
              ...
              : m.controlsContainer
              ? (T(m.controlsContainer).append(e),
                (m.directionNav = T(
                  "." + v + "direction-nav li a",
                  m.controlsContainer
                )))
              : (m.append(e),
                (m.directionNav = T("." + v + "direction-nav li a", m))),
              b.directionNav.update(),
              m.directionNav.bind(r, function (e) {
                var t;
                e.preventDefault(),
                  ("" !== o && o !== e.type) ||
                    ((t = T(this).hasClass(v + "next")
                      ? m.getTarget("next")
                      : m.getTarget("prev")),
                    m.flexAnimate(t, m.vars.pauseOnAction)),
                  "" === o && (o = e.type),
                  b.setToClearWatchedEvent();
              });
          },
          update: function () {
            var e = v + "disabled";
          ...
          setup: function () {
            ...
            m.controlsContainer
              ? (m.controlsContainer.append(e),
                (m.pausePlay = T("." + v + "pauseplay a", m.controlsContainer)))
              : (m.append(e), (m.pausePlay = T("." + v + "pauseplay a", m))),
              b.pausePlay.update(m.vars.slideshow ? v + "pause" : v + "play"),
              m.pausePlay.bind(r, function (e) {
                e.preventDefault(),
                  ("" !== o && o !== e.type) ||
                    (T(this).hasClass(v + "pause")
        ...
        smoothHeight: function (e) {
          if (!h || x) {
            ...
            e
              ...
              : t.height(m.slides.eq(m.animatingTo).height());
          }
        },
        sync: function (e) {
      ...
      (m.flexAnimate = function (e, t, a, n, s) {
        if (
          ...
          if (
            ...
            t && m.pause(),
            m.vars.before(m),
            m.syncExists && !s && b.sync("animate"),
            m.vars.controlNav && b.controlNav.active(),
            S)
          ) {
            var o = e * m.move;
            m.slides.length - o < m.move && (o = m.slides.length - m.move),
              m.slides
                .removeClass(v + "active-slide")
                .eq(o)
                .each(function () {
                  var e = T(this),
                    t = m.showItems;
                  for (i = 1; i <= t; i++)
                    e.addClass(v + "active-slide"), (e = e.next());
                });
          } else
            m.slides
              .removeClass(v + "active-slide")
          ...
          if (
            ...
            m.vars.directionNav && b.directionNav.update(),
            ...
            var l,
              d,
              c,
              u = h ? m.slides.filter(":first").height() : m.computedW;
            (d = S
              ? ((l = m.vars.itemMargin),
                (c = (m.itemW + l) * m.move * m.animatingTo) > m.limit &&
                1 !== m.visible
                  ? m.limit
                  : c)
              : 0 === m.currentSlide &&
              ...
              ? y
                ...
                : (m.count + 1) * u
              : y
              ? (m.count - 1 - e + m.cloneOffset) * u
              : (e + m.cloneOffset) * u),
              m.setProps(d, "", m.vars.animationSpeed),
              m.transitions
      ...
      (m.pause = function () {
        clearInterval(m.animatedSlides),
          ...
          (m.playing = !1),
          m.vars.pausePlay && b.pausePlay.update("play"),
          m.syncExists && b.sync("pause");
      }),
      (m.play = function () {
        m.playing && clearInterval(m.animatedSlides),
          ...
          m.vars.pausePlay && b.pausePlay.update("pause"),
          m.syncExists && b.sync("play");
      }),
      (m.stop = function () {
        m.pause(), (m.stopped = !0);
      }),
      ...
      (m.setup = function (e) {
        ...
        x
          ? (m.slides.css({
            ...
            m.vars.smoothHeight && b.smoothHeight())
          : ("init" === e &&
              ((m.viewport = T('<div class="' + v + 'viewport"></div>')
                .css({
                  overflow: "hidden",
                  position: "relative",
                })
              ...
              (m.cloneOffset = 0),
              y &&
                ((a = T.makeArray(m.slides).reverse()),
                (m.slides = T(a)),
                m.container.empty().append(m.slides))),
            m.vars.animationLoop &&
              !S &&
            ...
            (m.newSlides = T(m.vars.selector, m)),
            (t = y
        ...
        S
          ? (m.slides.addClass(v + "with-active-class"),
            m.slides
              .removeClass(v + "active-slide")
              .eq(m.currentSlide)
              .each(function () {
      ...
      (m.doMath = function () {
        ...
        "function" == typeof window.matchMedia
          ? (window.matchMedia("(max-width: 767px)").matches && (n = a = 1),
            window.matchMedia("(max-width: 419px)").matches && (n = a = 1))
          : (T(window).innerWidth() < 767 && (n = a = 1),
            T(window).innerWidth() < 419 && (n = a = 1)),
            ...
            ? ((m.showItems = a),
              ...
              (m.itemW =
                m.minW > m.w
                  ...
                  ? m.w
                  : m.vars.itemWidth),
              (m.visible = Math.floor((m.w + m.itemM) / (m.itemW + m.itemM))),
              (m.move =
        ...
        m.doMath(),
          ...
          m.vars.controlNav &&
            ...
            (("add" === t && !S) || m.pagingCount > m.controlNav.length
              ? b.controlNav.update("add")
              : (("remove" === t && !S) ||
                  m.pagingCount < m.controlNav.length) &&
                (S &&
                  m.currentSlide > m.last &&
                  (--m.currentSlide, --m.animatingTo),
                b.controlNav.update("remove", m.last))),
          m.vars.directionNav && b.directionNav.update();
      }),
      (m.addSlide = function (e, t) {
        ...
        (m.count += 1),
          ...
          m.update(t, "add"),
          (m.slides = T(m.vars.selector + ":not(.clone)", m)),
          m.setup(),
          m.vars.added(m);
      }),
      ...
      if ((void 0 === n && (n = {}), "object" == typeof n))
        return this.each(function () {
          var e = T(this),
            ...
            a = e.find(t);
          (1 === a.length && !0 === n.allowOneSlide) || 0 === a.length
            ? (a.fadeIn(400), n.start && n.start(e))
            : void 0 === e.data("goodlayers_flexslider") &&
              new T.goodlayers_flexslider(this, n);
        });
        ...
        (w.prototype.openGallery = function (t, e) {
          ...
          if ((void 0 === t && (t = this.settings.index), !this.lgOpened)) {
            ...
            this.zoomFromOrigin &&
              ...
              (o = E(e, this.outer, g, d, this.currentImageSize))),
        ...
        (w.prototype.loadContent = function (t, i) {
          ...
          b && !x(document.body).hasClass("lg-from-hash") && (k = b),
            ...
            (this.isFirstSlideWithZoomAnimation() &&
              ...
              this.onLgObjectLoad(r, t, b, k, y, !(!p || !p.html5 || l)),
            (this.zoomFromOrigin && this.currentImageSize) ||
          ...
          var c = "lg-youtube" + i,
            u =
              ...
              (this.settings.youTubePlayerParams
                ? "&" + r(this.settings.youTubePlayerParams)
                : "");
          s =
...
!(function (e, t) {
  ...
  function c() {
    ...
    if ((o(this, "_id", "_WeakMap_" + f() + "." + f()), 0 < arguments.length))
  ...
  function M(n, r) {
    ...
    (r = P(r)).event
      ? ("error" === r.event &&
          y(n, r.data.method).forEach(function (e) {
            var t = new Error(r.data.message);
            (t.name = r.data.name), e.reject(t), g(n, r.data.method, e);
          }),
        (a = y(n, "event:".concat(r.event))),
        (t = r.data))
      : r.method &&
        ((e = n),
        (o = r.method),
        (i = !((i = y(e, o)).length < 1) && ((i = i.shift()), g(e, o, i), i)) &&
          (a.push(i), (t = r.value))),
  ...
  var N,
    ...
    Player = (function () {
      function Player(i) {
        ...
        if (
          ("IFRAME" === i.nodeName ||
            ((r = i.querySelector("iframe")) && (i = r)),
          "IFRAME" === i.nodeName && !l(i.getAttribute("src") || ""))
        )
        ...
        return (
          ...
          A.isEnabled &&
            ...
            (this.fullscreenchangeHandler = function () {
              (A.isFullscreen ? p : g)(a, "event:exitFullscreen", n),
            ...
            value: function () {
              ...
              return new m(function (e) {
                ...
                j.delete(n),
                  ...
                  A.isEnabled &&
                    A.off("fullscreenchange", n.fullscreenchangeHandler),
                  e();
              });
            },
          },
          ...
          return new Promise(function (t, e) {
            ...
            x.isFullscreen
              ? ((n = function e() {
                ...
                x.on("fullscreenchange", n),
                (r = document[N.exitFullscreen]()) instanceof Promise &&
                  r.then(n).catch(e))
              : t();
          });
        },
...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
    ? define(e)
    : ((t = "undefined" != typeof globalThis ? globalThis : t || self).lgShare =
        e());
})(this, function () {
  "use strict";
  var t = function () {
  ...
  function e() {
    ...
    var o = Array(t),
      n = 0;
    for (e = 0; e < r; e++)
      for (var i = arguments[e], s = 0, a = i.length; s < a; s++, n++)
        o[n] = i[s];
    return o;
  }
  var r = {
  ...
  function o(t) {
    return (
      ...
      encodeURIComponent(t.facebookShareUrl || window.location.href)
    );
  }
  ...
  return (function () {
    function a(e) {
      return (
        (this.shareOptions = []),
        (this.core = e),
        (this.settings = t(t({}, r), this.core.settings)),
        this
      );
    }
    return (
